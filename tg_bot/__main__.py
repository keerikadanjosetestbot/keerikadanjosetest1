...
PM_START_TEXT = """
ഹായ് {}, എന്റെ പേര് {}! എന്നെ ഉപയോഗിക്കേണ്ടത് എങ്ങനെ ആണെന്നുള്ളതിൽ എന്തേലും സംശയം ഉണ്ടെങ്കിൽ /help.

എന്നെ ആശാൻ  [ഇദ്ദേഹം](tg://user?id={}) ആണ്.
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("ഹായ് പറഞ്ഞോളൂ ...ഇത് ജോസാണ്")
